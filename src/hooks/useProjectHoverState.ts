...
import { HOVER_RESET_DELAY, COMING_SOON_PROJECT_IDS, COMING_SOON_NAMES } from '../utils/constants';
...
export const useProjectHoverState = (
  ...
  const handleProjectMouseEnter = useCallback((project: ProjectSummary) => {
