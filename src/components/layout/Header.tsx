...
const Header = ({
  ...
  const introScrambleActive =
    welcomeTransitionComplete && !introScrambleTriggeredRef.current;
          ...
          >
            ...
            >
              {navItems.map((item) => {
                ...
                const isHovered =
                  hoveredNavItem === item.name || introScrambleActive;
                return (
                  <motion.a
                    key={item.name}
                    href="#"
                  ...
                  >
                    ...
                    <ScrambleText
                      ...
                      preserveSpaces={true}
                      retriggerKey={
                        navItemRetriggerKeysRef.current[item.name] || 0
                      }
                    />
                    <span
                      className={`nav-bracket ${isActive ? "nav-bracket-active" : ""}`}
