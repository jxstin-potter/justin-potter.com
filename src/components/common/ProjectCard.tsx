...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  const isComingSoon =
    project.id >= comingSoonIds.min && project.id <= comingSoonIds.max;
  const shouldApplyDesktopEffects = !isTouchDevice;
  ...
  return (
    <MotionLink
      ...
      onTouchStart={() => onProjectMouseEnter(project)}
      onFocus={() => onProjectMouseEnter(project)}
      transition={{
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          animate={{
            filter:
              shouldApplyDesktopEffects && isAnyCardHovered && !isHovered
                ? "blur(4px)"
                : "blur(0px)",
            clipPath:
              shouldApplyDesktopEffects && isAnyCardHovered && !isHovered
          ...
          style={{
            ...
            willChange: shouldApplyDesktopEffects
              ? "transform, filter"
              : "transform",
